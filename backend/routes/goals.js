...
router.post('/', auth, async (req, res) => {
  ...
  const { name, duration, startDate, type, units, total, compId, isPrivate, initialValue } = req.body;
...
router.put('/:id', auth, async (req, res) => {
  const { name, duration, startDate, type, units, total, isPrivate, tracker } = req.body;
